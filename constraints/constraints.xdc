...
##Buttons
set_property PACKAGE_PIN U18 [get_ports i_B_button]						
	set_property IOSTANDARD LVCMOS33 [get_ports i_B_button]
set_property PACKAGE_PIN W19 [get_ports i_A_button]						
	set_property IOSTANDARD LVCMOS33 [get_ports i_A_button]
set_property PACKAGE_PIN T17 [get_ports i_OP_button]						
	set_property IOSTANDARD LVCMOS33 [get_ports i_OP_button]
#set_property PACKAGE_PIN T18 [get_ports i_B_button]						
	#set_property IOSTANDARD LVCMOS33 [get_ports i_B_button]
...
##VGA Connector
set_property PACKAGE_PIN G19 [get_ports {o_locked}]				
